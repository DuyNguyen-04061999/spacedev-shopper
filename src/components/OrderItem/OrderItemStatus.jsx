...
export const OrderItemStatus = withLoading(({ _id, status, total, createdAt, confirmDate, finishedDate, shippingDate  }) => {
    const strCreatedAt = useMemo(() => moment(createdAt).format(DATE_FORMAT), [createdAt])
