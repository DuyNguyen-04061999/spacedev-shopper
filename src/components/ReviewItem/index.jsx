                    ...
                    <div className="row">
                        <div className="col-12 col-md-auto">
                            ...
                            <div className="avatar avatar-xxl mb-6 mb-md-0">
                                <span className="avatar-title rounded-circle">
                                    {
                                        user.avatar ? <div className="w-[100px] h-[100px] rounded-full overflow-hidden"><img className="w-full h-full object-cover" src={user.avatar} /></div> : <i className="fa fa-user" />
                                    }
                                </span>
                            </div>
                        </div>
                        <div className="col-12 col-md">
                            ...
                            <div className="row mb-6">
                                ...
                                <div className="col-12">
                                    {/* Time */}
                                    <span className="font-size-xs text-muted">
                                        {user.name}, <time dateTime="2019-07-25">{moment(createdAt).local('vi').format('MMM DD YYYY')}</time>
                                    </span>
                                </div>
                            </div>
                            {/* Text */}
