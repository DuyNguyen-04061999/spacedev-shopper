...
Tab.Title = ({ children, value }) => {
    const { indexActive, setIndexActive, registerTitleIndex, name, onChange, onChangeSearchParams } = useContext(Context)
    ...
    return <a onClick={onClick} className={cn('nav-link', { active: indexActive == _index })} href="#">{children}</a>
}
