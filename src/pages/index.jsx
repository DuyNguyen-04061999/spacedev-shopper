          ...
          <div className="container">
            ...
            <div className="tab-content">
              <Tab.Content  value="do-dien-tu">
                <ListProductCardDiscover query="?categories=4221&limit=8" link="/dien-tu-dien-lanh/4221"/>
              </Tab.Content>
              <Tab.Content value="do-gia-dung">
                <ListProductCardDiscover query="?categories=1882&limit=8" link="/dien-gia-dung/1882"/>
              </Tab.Content>
              <Tab.Content value="san-pham-khuyen-mai">
                <ListProductCardDiscover query="?sort=discount_rate.desc&limit=8" link="/san-pham?page=1&sort=discount_rate.desc"/>
              </Tab.Content>
            </div>
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-12">
              {/* Slider */}
              <Slider slidesPerView={3} spaceBetween={30} style={{ paddingBottom: 40 }}>
                {
                  reviews?.map(e => <ReviewCard key={e._id} {...e} />)
                }
              </Slider>
            </div>
          </div>
